...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 16, 2019 at 04:49 AM
...
INSERT INTO `booking` (`bid`, `room_no`, `r_category`, `name`, `phone`, `address`, `email`, `payment_process`, `payment`, `due`, `date`, `duration`, `discount`, `checkin`, `checkout`, `checkin_date`, `checkout_date`) VALUES
(1001, 202, 'AC', 'Jabir', 155478961, 'ECB,Dhaka', 'jabir@gmail.com', 'Bkash', 1500, 12000, '11 April 2019', '1440', '0%', 1, 1, '12 April 2019', '13 April 2019'),
(1002, 304, 'NON AC', '\r\nAbir', 5454577, 'Matijheel,Dhaka', '', 'Cash', 500, 850, '16-04-19', '360', '5%', NULL, NULL, NULL, NULL),
(1003, 301, 'NON AC', 'Jonathan', 310569745, 'Canada', 'jonathan@gmail.com', 'Rocket', 3000, 400, '16-04-2019', '1440', '15%', NULL, NULL, NULL, NULL);
...
--
-- Table structure for table `food2`
--
...
--
-- Dumping data for table `food2`
--

INSERT INTO `food2` (`order_id`, `bid`, `room_no`, `food_id`, `price`) VALUES
(1, 1001, 202, 5, 200),
(2, 1001, 202, 454, 822),
(3, 1001, 202, 69, 9000);
...
--
ALTER TABLE `booking`
  MODIFY `bid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1005;

--
-- AUTO_INCREMENT for table `food2`
--
ALTER TABLE `food2`
...
--
ALTER TABLE `room`
  MODIFY `room_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=402;
COMMIT;
